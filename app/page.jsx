...
const page = () => {
  ...
  const projects = [
    ...
    {
      title: "URL Shortener",
      desc: "Create short, easy-to-share links instantly. Built with a modern full-stack architecture for fast performance and seamless user experience.",
                ...
                <div className="flex gap-3 flex-wrap">
                  {item.link ? (
                    <Link
                      ...
                      className="border border-[#C778DD] px-4 py-2 hover:bg-[#473a54] transition inline-block"
                    >
                      {item.btn1}
                    </Link>
                  ) : null}
