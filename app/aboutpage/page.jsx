...
const AboutPage = () => {
  ...
  {/* Left Box */}
  <div className="hidden lg:block absolute left-0 top-1/2 -translate-y-1/2 w-12 h-24 border border-[#ABB2BF] opacity-50"></div>
  ...
  <div className="max-w-7xl mx-auto">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
      {/* Languages */}
      <div className="border border-[#ABB2BF] hover:border-[#C778DD] transition duration-300">
        <div className="border-b border-[#ABB2BF] px-3 py-2 text-sm font-semibold">
          Languages
        </div>
        <div className="px-3 py-3 text-[#ABB2BF] text-sm leading-7">
          TypeScript Lua
          <br />
          Python JavaScript
        </div>
